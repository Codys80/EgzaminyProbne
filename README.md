...
### Program główny: (fragment działania jest widoczny na obrazie 1)
 ...
 - Sprawdza działanie wszystkich metod:
   ...
   - Wyszukującej: jeżeli wartość została wyszukana, wyświetlany jest w programie głównym komunikat z wartością indeksu wyszukanej. W przeciwnym wypadku nic nie jest wyświetlane
